...
default['newrelic']['application_monitoring']['daemon']['record_database_errors'] = true
default['newrelic']['application_monitoring']['daemon']['stack_trace_threshold'] = "200ms"
default['newrelic']['application_monitoring']['daemon']['stack_trace_threshold'] = "100ms"
